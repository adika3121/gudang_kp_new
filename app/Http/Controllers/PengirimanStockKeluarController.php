...
class PengirimanStockKeluarController extends Controller
{
  /**
   ...
   */
   ...
   public function tambah_sn_keluar(Request $request){
     ...
     return view('pengiriman.pengiriman-sn_stockKeluar', compact('nama_outlet', 'kode_master', 'id_master'));
   }
  ...
  public function create(Request $request)
  {
      ...
      $nama_barang = master::where('kode_outlet', $nama_outlet)
                    ...
                    -> get();
      return view('pengiriman.pengiriman-tambah_stock_keluar', compact('nama_barang'));
  }
  ...
  public function store(Request $request)
  {
      ...
      if($validator->passes()){
        ...
        return view('pengiriman.pengiriman-sukses_stockKeluar', compact('nama_outlet', 'kode_master', 'ket', 'id_master', 'stock_out'));
        ...
        return View::make('pengiriman.pengiriman-sn_stockKeluar', $data)->withErrors($validator);
