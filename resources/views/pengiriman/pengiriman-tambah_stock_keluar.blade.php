@extends('layout.layout-pengiriman')
...
<section role="main" class="content-body">
  ...
  <!-- start: page -->
  <form action="{{action('PengirimanStockKeluarController@tambah_sn_keluar')}}" method="post" class="form-horizontal">
    <section class="panel">
  ...
  {{--  <!-- modal tambah sn Keluar -->
  			<div class="modal fade" id="tambahSN" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                ...
                <div class="card" style="center">
                    <form action="{{action('PengirimanStockKeluarController@store')}}" method="post" class="form-horizontal" id="tambahStock">
                      {{ csrf_field() }}
                      <!-- Form Isi Stock Keluar -->
                      <div class="row form-group">
                          <div class="col col-md-3">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="mb-md">
                            ...
                            <a href="/pengiriman-stock-keluar" class="btn btn-warning">Selesai</a>
                          </div>
                        </div>
                      </div>
                      <!-- End button  -->
