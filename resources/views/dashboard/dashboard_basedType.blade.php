...
@section('title')
  Dashboard Gudang | Stock {{$nama_kategori->nama}}
@endsection
    ...
    <div class="col-md-12">
        <section class="panel">
          <header class="panel-heading">
            ...
            <h2 class="panel-title">Data Stock {{$nama_kategori->nama}} </h2>

          </header>
          <div class="panel-body">
          <!-- Tampilan Stock berdasarkan kategorinya-->
