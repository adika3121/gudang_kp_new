    ...
    <div class="col-md-12">
      <section class="panel">
        ...
        <div class="card" style="center">
            ...
            <form action="{{action('MarketingController@lihat_stock_based_type')}}" method="post" class="">
      ...
      <div class="col-md-6">
          <section class="panel">
            ...
            <div class="card" style="center">
                ...
                <form action="{{action('MarketingController@lihat_stock_masuk_terbaru')}}" method="post" class="">
                <div class="card-body card-block">
                    {{ csrf_field() }}
                        <div class="form-group">
    ...
    <div class="col-md-6">
        <section class="panel">
          ...
          <div class="card" style="center">
              ...
              <form action="{{action('MarketingController@lihat_stock_keluar_terbaru')}}" method="post" class="">
              <div class="card-body card-block">
                  {{ csrf_field() }}
                      <div class="form-group">
                          <label for="outlet" class=" form-control-label">Nama Outlet</label>
      ...
      <div class="col-md-12">
        <section class="panel">
          ...
          <div class="card" style="center">
              ...
              <form action="{{action('MarketingController@lihat_stock_outlet')}}" method="post" class="">
              <div class="card-body card-block">
                  {{ csrf_field() }}
                      <div class="form-group">
                          <label for="outlet" class=" form-control-label">Nama Outlet</label>
